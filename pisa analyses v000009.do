...
********************************************************************************
global data "/Users/nikkishure/Documents/UCL IOE/PISA physical activity/Data"
global output "/Users/nikkishure/Documents/UCL IOE/PISA physical activity/Output"
********************************************************************************
...
twoway (scatter n q0_b , msize(.5) mcolor("red")) (rcap q0_lci q0_uci n , horizontal  lcolor("red")  msize(0)  ) ///
	   ...
	   , ylabel(1(1)51, ang(h) labsize(tiny) valuelabel noticks) legend(off)  ytitle("") xlabel(1(1)5.5) ///
